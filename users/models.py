...
from core.constants import MAX_ABOUT_LEN, MAX_NAME_LEN, MAX_PHONE_LEN, MAX_SURNAME_LEN
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    surname = models.CharField(max_length=MAX_SURNAME_LEN, verbose_name="Фамилия")
